...
def serve(
    ...
    agent_loop = AgentLoop(
        ...
        show_token_usage=runtime_config.agents.defaults.show_token_usage,
    )
...
def gateway(
    ...
    agent = AgentLoop(
        ...
        show_token_usage=config.agents.defaults.show_token_usage,
    )
...
def status():
    ...
    console.print(f"{__logo__} nanobot-sh Status\n")
